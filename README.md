...
| - |  |  |  |
| 4 | **oracle-booklet** | skill + code | "Turn ONE session's real work into a |
| 5 | **oracle-family-scan** | skill + code | Oracle Family Registry |
| 6 | **project** | skill + code | Clone and track external repos |
| 7 | **recap** | skill + code | Session orientation and awareness |
| 8 | **schedule** | skill + code | Query schedule via Oracle API (Drizzle DB) |
| - |  |  |  |
...
| 25 | **oracle-book-cover** | skill | '[standard] G-SKLL | Design a beautiful |
